-- ============================================================
-- QUERY ULTRA-OTIMIZADA V2 - MySQL 5.7
-- ============================================================
-- VERSÃO COM TABELA TEMPORÁRIA EM DISCO (para datasets grandes)
-- Se seus dados não couberem na memória, use esta versão
-- ============================================================

-- PASSO 1: Criar tabela temporária em disco (sem ENGINE=MEMORY)
...
CREATE TEMPORARY TABLE temp_base_data (
  ...
  fl_pendente TINYINT,
  fl_atrasada TINYINT,
  fl_futura_em_aberto TINYINT,
  INDEX idx_contrato (id_cliente, id_categoria, metodo_pagamento),
  INDEX idx_venc (dt_venc),
  INDEX idx_flags (fl_atrasada, fl_futura_em_aberto)
) ENGINE=MyISAM;

-- PASSO 2: Popular a tabela temporária (1 scan da tabela original)
INSERT INTO temp_base_data
SELECT
  id_cliente,
  nome_cliente,
  id_categoria,
