-- ============================================================
-- QUERY ULTRA-OTIMIZADA - MySQL 5.7
-- ============================================================
-- Esta versão usa TABELA TEMPORÁRIA para evitar múltiplos scans
-- Deve ser MUITO mais rápida (5-10x) que a versão anterior
-- ============================================================

-- PASSO 1: Criar tabela temporária com dados normalizados
-- Isso escaneia a tabela original apenas 1 vez!
DROP TEMPORARY TABLE IF EXISTS temp_base_data;
CREATE TEMPORARY TABLE temp_base_data
ENGINE=MEMORY  -- Usa memória para máxima velocidade
SELECT
  id_cliente,
  nome_cliente,
  id_categoria,
